...
#ifndef NS_UTIL_FLOATINGPOINT_H
#define	NS_UTIL_FLOATINGPOINT_H
...
namespace util
{
    static const int DECIMAL_STRING_LENGTH = 512; ///< Size of buffer in decimal_record.
