...
namespace util
{
    ...
    public:
        ...
        /**
         * Default constructor.
         * @param type standard type of cracket. defaulted to NONE.
         */
         ...
         */
        const std::string& left(const std::string& customLeft = "",
                                const std::string& customRight = "") const
        {
         ...
         * @return the left bracket as string.
         */
        const std::string& inner(const std::string& customLeft = "",
                                 const std::string& customRight = "") const
        {
         ...
         */
        const std::string& right(const std::string& customLeft = "",
                                 const std::string& customRight = "") const
        {
