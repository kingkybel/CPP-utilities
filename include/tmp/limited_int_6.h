...
template<typename, typename T_, typename = void >
struct is_out_of_bounds_resolver : std::false_type { };

template<typename Res_, typename T_, typename>
struct is_out_of_bounds_resolver<Res_, T_, decltype( Res_::resolve(std::declval<T_>(),
                                                                   std::declval<T_>(),
                                                                   std::declval<T_ &>(),
...
struct limited_int_traits
{
    ...
    constexpr static INT_ invalid()
    {
        ...
        static_assert(is_out_of_bounds_resolver<Resolver, INT_>::value, "invalid out_of_bounds_resolver");
