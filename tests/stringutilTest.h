...
class stringutilTest : public CPPUNIT_NS::TestFixture
{
    ...
    CPPUNIT_TEST(util_ci_traits_test);
    CPPUNIT_TEST(util_container_conversion_test);
    CPPUNIT_TEST(util_string_test);
    CPPUNIT_TEST(util_ci_string_test);
