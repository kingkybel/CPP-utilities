...
void util_any_test(int ii, int jj)
{
    ...
    BOOST_CHECK(itv_0L_1L.contains(0.5));
    Interval<VAR_FLOAT> itv_minus1_2(-1.0L, 2.0L);
    BOOST_CHECK(itv_0L_1L.isSubIntervalOf(itv_minus1_2));
...
void util_event_operation_test(int i, int j)
{
    ...
    BOOST_TEST_MESSAGE("====== Testing event explicit operations ========");
    {
        ...
        BOOST_TEST_MESSAGE("match to interval");
        {
            ...
            BOOST_CHECK(Event("E1", toDate(2014, 2, 3)).matches(itv_20140203_20150203));
            BOOST_CHECK(Event("E1", toDate(2015, 2, 3)).matches(itv_20140203_20150203));
            BOOST_CHECK(Event("E1", toDate(2014, 3, 3)).matches(itv_20140203_20150203));
            BOOST_CHECK(!Event("E1", toDate(2014, 2, 2)).matches(itv_20140203_20150203));
            BOOST_CHECK(!Event("E1", toDate(2015, 2, 4)).matches(itv_20140203_20150203));
        }
        {
        ...
        }
        {
            ...
            BOOST_CHECK(Event("E1", toDate(2014, 2, 2)).matches(itv_oo_20140203));
            BOOST_CHECK(!Event("E1", toDate(2015, 2, 4)).matches(itv_oo_20140203));
        }
